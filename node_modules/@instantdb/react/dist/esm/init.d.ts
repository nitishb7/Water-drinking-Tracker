 ...
 */
export declare function init<Schema extends InstantSchemaDef<any, any, any> = InstantUnknownSchema, UseDates extends boolean = false>(config: InstantConfig<Schema, UseDates>): InstantReactWebDatabase<Schema, InstantConfig<Schema, UseDates>>;
/**
 * @deprecated
