 ...
 */
declare function init<Schema extends InstantSchemaDef<any, any, any> = InstantUnknownSchema, UseDates extends boolean = false>(config: InstantConfig<Schema, UseDates>, Storage?: any, NetworkListener?: any, versions?: {
    [key: string]: string;
